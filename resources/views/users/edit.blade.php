  ...
  <div class="container">
    <form action="" method="POST"> 
      ...
      <div class="form-group row">
        ...
        <div class="col-sm-10">
          <input type="password"value="{{$user->password}}" name="password" class="form-control" id="inputPassword3" placeholder="Password">
        </div>
      </div>
      ...
      <div class="form-group row">
        <div class="col-sm-10">
          <button type="submit" class="btn btn-primary" style="background: linear-gradient(45deg, #ffcccb, #ff7a75, #ff6347);">Submit</button>
        </div>
      </div>
    </form>
  </div>
